...
```mermaid
flowchart LR
    A["1. Playwright Browser Agent"] --> B["2. Multimodal LLM Extractor"]
    B --> C["3. Delta Diff Engine"]
    C --> D["4. Excel Tracker (.xlsx)"]
    D --> E["5. Executive Email Digest"]
```
